...
palette = plt.cm.gray.with_extremes(over='orange', under='b', bad='b')
...
ax.plot_surface(X, Y, 2*eigenvalues[:, :, 1]/Delta_0,
                linewidth=0, antialiased=True,
                alpha=0.2, cmap=palette, norm=colors.Normalize(vmin=0, vmax=0.01), edgecolor='blue', lw=0.5, rstride=5, cstride=5)
ax.plot_surface(X, Y, 2*eigenvalues[:, :, 1]/Delta_0,
                linewidth=0, antialiased=True,
                alpha=0.3, cmap=palette, norm=colors.Normalize(vmin=0, vmax=0.01))

ax.plot_surface(X, Y, 2*eigenvalues[:, :, 2]/Delta_0,
                linewidth=0, antialiased=True,
                alpha=0.2, cmap=palette2, norm=colors.Normalize(vmin=-0.01, vmax=0), edgecolor='green', lw=0.5, rstride=5, cstride=5)
ax.plot_surface(X, Y, 2*eigenvalues[:, :, 2]/Delta_0,
                linewidth=0, antialiased=True,
                alpha=0.3   , cmap=palette2, norm=colors.Normalize(vmin=-0.01, vmax=0))
...
ax.fill_between(-0.13, np.linspace(-0.1, 0.1, 50), 2*eigenvalues[25, :, 1]/Delta_0, -0.13, np.linspace(-0.1, 0.1, 50), 0,
                where=2*eigenvalues[25, :, 1]/Delta_0>0,
                alpha=1, color="orange")

ax.fill_between(-0.13, np.linspace(-0.1, 0.1, 50), 2*eigenvalues[25, :, 2]/Delta_0, -0.13, np.linspace(-0.1, 0.1, 50), 0,
